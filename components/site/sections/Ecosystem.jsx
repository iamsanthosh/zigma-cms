export default function Ecosystem({ data, backgroundStyle }) {
  ...
  const customBgColor = data.backgroundColor ? { backgroundColor: data.backgroundColor } : {};

  return (
    <section className={`ecosystem-section ${themeClass}`} style={customBgColor}>
      <div className="container">
        <div className="eco-grid">
          <div className="eco-visual">
            {data.ecoImage?.url ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={data.ecoImage.url} alt="Ecosystem visual" style={{ width: '100%', height: 'auto', borderRadius: '8px' }} />
            ) : (
