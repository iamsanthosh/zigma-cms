...
export const sectionSchemas = {
  ...
  footer: {
    label: 'Footer',
    fields: [
      { name: 'tagline', label: 'Tagline / about text', type: 'textarea' },
      { name: 'phone', label: 'Phone number', type: 'text' },
      { name: 'email', label: 'Email address', type: 'text' },
      { name: 'emergencyLabel', label: 'Emergency line label', type: 'text' },
      { name: 'emergencyUrl', label: 'Emergency line link', type: 'url' },
      { name: 'newsletterEnabled', label: 'Show newsletter signup', type: 'boolean' },
      { name: 'copyrightText', label: 'Copyright line', type: 'text' },
      {
        name: 'socialLinks',
        label: 'Social links',
        type: 'repeater',
        fields: [
          { name: 'platform', label: 'Platform (facebook/instagram/linkedin/x/youtube)', type: 'text' },
          { name: 'url', label: 'URL', type: 'url' }
        ]
      }
      // Footer link columns (Company / Capabilities) are driven by the
      // `menus` resource with slugs footer-company / footer-capabilities.
    ]
  },
